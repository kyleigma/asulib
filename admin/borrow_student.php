            ...
            <div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Student Borrow</h1>
                        <nav style="--bs-breadcrumb-divider: '>';font-size:85%;" aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class=""><i class="fas fa-angle-right"></i></li>&nbsp;&nbsp;&nbsp;
                                <li class="active" aria-current="page">Student Borrow</li>
                            </ol>
                        </nav>
                    </div>
                        ...
                        <a href="#addnew" data-toggle="modal" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> New</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php
                                        $qry = mysqli_query($conn, "SELECT *, borrow.id as id, students.student_id AS stud, borrow.status AS barstat FROM borrow LEFT JOIN students ON students.id = borrow.student_id LEFT JOIN books ON books.id = borrow.book_id WHERE faculty_id IS NULL OR faculty_id = '' ORDER BY borrow.date_borrow DESC, borrow.status DESC");
                                    ...
                                    <tr class="text-center">
                                    <td><?php echo date('M j, Y', strtotime($qry2['date_borrow'])); ?></td>
