                    ...
                    <div class="container mt-5">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-12 col-md-6 col-lg-5 mb-5">
                                <a href="return_faculty.php" class="text-decoration-none text-inherit">
                                    <div class="card border-left-primary shadow d-flex flex-column justify-content-center align-items-center h-100 p-4">
                                        <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                            <i class="fas fa-user fa-4x text-primary-300 mb-3"></i>
                            ...
                            <!-- Second Card -->
                            <div class="col-12 col-md-6 col-lg-5 mb-5">
                                <a href="return_student.php" class="text-decoration-none text-inherit">
                                    <div class="card border-left-primary shadow d-flex flex-column justify-content-center align-items-center h-100 p-4">
                                        <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                            <i class="fas fa-graduation-cap fa-4x text-primary-300 mb-3"></i>
                                            <div class="text-center">
                                                <div class="font-weight-bold text-primary text-uppercase">
                                                    Student
                                                </div>
