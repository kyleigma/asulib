    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="borrow_student_add.php">
                ...
                <div class="form-group">
                    <div class="col-sm-9 col-sm-offset-3">
                      <button type="button" class="btn btn-primary btn-xs btn-flat" id="append"><i class="fa fa-plus"></i> Book Field</button>
                    </div>
                </div>
          	</div>
...
<div class="modal fade" id="addnew2">
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="borrow_faculty_add.php">
          		  <div class="form-group row mx-0">
                ...
                <span id="append-div2"></span>
                <div class="form-group">
                    <div class="col-sm-9 col-sm-offset-3">
                        <button type="button" class="btn btn-primary btn-xs btn-flat" id="append2"><i class="fa fa-plus"></i> Book Field</button>
                    </div>
                </div>
          	</div>
          	<div class="modal-footer">
...
<script>
    // Function to append new accession input fields
    function appendAccessionInput(buttonId, appendDivId) {
        const appendButton = document.getElementById(buttonId);
        appendButton.addEventListener('click', function() {
            ...
            newInput.name = 'accession[]'; // Ensure it's an array
            ...
            // Append the new form group to the specified appendDiv
            const appendDiv = document.getElementById(appendDivId);
            appendDiv.appendChild(newFormGroup);
        });
    }

    // Initialize the append function for both modals
    appendAccessionInput('append', 'append-div');
    appendAccessionInput('append2', 'append-div2');
</script>
